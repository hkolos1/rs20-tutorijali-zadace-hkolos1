...
class ArtikalTest {
    ...
    void testtoString(){
        ...
        proizvod = new Artikal("HARA1", "Kisela voda", 2);
        String artikal_string=proizvod.toString();
        assertEquals("HARA1,Kisela voda,2.0", artikal_string);
    }

    @Test
    void testArtikalString(){
        Artikal proizvod = new Artikal("HARA2", "Brašno", 2.30);
        String spojeno=proizvod.toString();
        Artikal spojeni_proizvod = new Artikal(spojeno);
        assertEquals("Brašno", spojeni_proizvod.getNaziv());
    }
}