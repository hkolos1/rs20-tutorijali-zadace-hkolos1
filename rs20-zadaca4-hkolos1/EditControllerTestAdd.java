...
class EditControllerTestAdd {
    ...
    public void testAddValidatePublishDate(FxRobot robot) {
        ...
        // Uzmi boju - koristimo getEditor metodu jer funkcija isNotValid prima TextField
        DatePicker datePicker = robot.lookup("#dpPublishDate").queryAs(DatePicker.class);
        assertTrue(sadrziStil(datePicker, "poljeNijeIspravno"));

        // Probavamo Ok
        robot.clickOn("#btnOk");
        // Da li je forma i dalje vidljiva?
        ...
        // Da li je getBook vratio novu unesenu knjigu?
        Book b = controller.getBook();
