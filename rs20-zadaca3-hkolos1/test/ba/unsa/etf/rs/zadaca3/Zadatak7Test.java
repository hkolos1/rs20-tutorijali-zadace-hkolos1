...
//        robot.write("ab");
//
//        // Lozinka sadrži isključivo mala slova tako da nije ispravna
//        TextField ime = robot.lookup("#fldPassword").queryAs(TextField.class);
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Lozinka sadrži i velika slova, i dalje nije ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("C");
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Sada dodajemo i cifre tako da je ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("1");
//        assertTrue(sadrziStil(ime, "poljeIspravno"));
//
//        // Brišemo posljednji karakter, opet nije ispravno
//        robot.clickOn("#fldPassword");
...
//    }
    ...
    @Test
    void testPassword1UradjenZadatak4(FxRobot robot) {
        // Provjera da li se polje Lozinka validira po pravilima opisanim u postavci zadatka
        robot.clickOn("Delić Amra");
        robot.clickOn("#fldPassword");
        robot.press(KeyCode.CONTROL).press(KeyCode.A).release(KeyCode.A).release(KeyCode.CONTROL);
...
//        robot.write("1234");
//
//        // Lozinka sadrži isključivo cifre, nije ispravna
//        TextField ime = robot.lookup("#fldPassword").queryAs(TextField.class);
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Lozinka sada sadrži cifre i velika slova ali nema malih slova, i dalje nije ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("C");
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Dodajemo i mala slova, sada jeste ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("c");
//        assertTrue(sadrziStil(ime, "poljeIspravno"));
//
//        // Brišemo posljednji karakter, opet nije ispravna
//        robot.clickOn("#fldPassword");
//        robot.press(KeyCode.BACK_SPACE).release(KeyCode.BACK_SPACE);
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Dodajemo još znakova, sada opet jeste ispravna
//        robot.clickOn("#fldPasswordRepeat");
//        robot.write("De");
//        robot.clickOn("#fldPassword");
//        robot.write("De");
...
//    }
    ...
    @Test
    void testPassword2UradjenZadatak4(FxRobot robot) {
        // Provjera da li se polje Lozinka validira po pravilima opisanim u postavci zadatka
        robot.clickOn("Delić Amra");
        robot.clickOn("#fldPassword");
        robot.press(KeyCode.CONTROL).press(KeyCode.A).release(KeyCode.A).release(KeyCode.CONTROL);
...
//        robot.write("Aa1");
//
//        // Lozinka je validna jer sadrži veliko, malo slovo i cifru
//        TextField ime = robot.lookup("#fldPassword").queryAs(TextField.class);
//        assertTrue(sadrziStil(ime, "poljeIspravno"));
//
//        // Brišemo cifru, sada nije ispravna
//        robot.clickOn("#fldPassword");
//        robot.press(KeyCode.BACK_SPACE).release(KeyCode.BACK_SPACE);
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Dodajemo slovo, i dalje nije ispravna jer ne sadrži cifru
//        robot.clickOn("#fldPassword");
//        robot.write("C");
//        assertTrue(sadrziStil(ime, "poljeNijeIspravno"));
//
//        // Dodajemo cifru, sada je opet ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("9");
//        assertTrue(sadrziStil(ime, "poljeIspravno"));
//
//        // Dodajemo još znakova, i dalje je ispravna
//        robot.clickOn("#fldPassword");
//        robot.write("De8");
//        assertTrue(sadrziStil(ime, "poljeIspravno"));
//    }
    ...
    @Test
    void testPassword3UradjenZadatak4(FxRobot robot) {
        // Provjera da li se polje Lozinka validira po pravilima opisanim u postavci zadatka
        robot.clickOn("Delić Amra");
        robot.clickOn("#fldPassword");
        robot.press(KeyCode.CONTROL).press(KeyCode.A).release(KeyCode.A).release(KeyCode.CONTROL);
...
//    }
    ...
    @Test
    void testNistaNijeIzabranoUradjenZadatak4(FxRobot robot) {
        // Nemoj se krahirati ako nijedan korisnik nije izabran
        robot.clickOn("#fldPassword");
        robot.write("Aa1");
        robot.clickOn("#fldPasswordRepeat");
