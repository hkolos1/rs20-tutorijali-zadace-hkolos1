...
public class Zadatak8Plus9Test {
    ...
    @Test
    void generisiListaUradjenZadatak9(FxRobot robot) {
    ...
    @Test
    void generisiModelUradjenZadatak9(FxRobot robot) {
        robot.clickOn("Fejzić Rijad");
    ...
    @Test
    void generisiNoviUradjenZadatak9(FxRobot robot) {
    ...
    @Test
    void generisiNoviModelUradjenZadatak9(FxRobot robot) {
        Platform.runLater(
    ...
    @Test
    void testPraznoUradjenZadatak9(FxRobot robot) {
        robot.clickOn("#btnDodaj");
        robot.clickOn("#btnGenerisi");
        Platform.runLater(
